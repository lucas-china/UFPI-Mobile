...
public class CalendarioPos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendario_pos);
        ...
        final ArrayAdapter adapter = new ArrayAdapter(CalendarioPos.this, android.R.layout.simple_list_item_1, informacoes);
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_CalendarioPos);
