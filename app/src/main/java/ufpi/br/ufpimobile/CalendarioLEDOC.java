...
public class CalendarioLEDOC extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendario_ledoc);
        ...
        final ArrayAdapter adapter = new ArrayAdapter(CalendarioLEDOC.this, android.R.layout.simple_list_item_1, informacoes);
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_CalendarioLEDOC);
    ...
    private final Response.ErrorListener onPostsError = new Response.ErrorListener() {
        ...
        public void onErrorResponse(VolleyError error) {
            //Log.e("CalendarioLEDOCActivity", error.toString());
        }
    };
