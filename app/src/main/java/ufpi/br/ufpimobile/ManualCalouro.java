...
public class ManualCalouro extends AppCompatActivity implements
        OnPageChangeListener,OnLoadCompleteListener {

    private static final String TAG = ManualCalouro.class.getSimpleName();
    public static final String SAMPLE_FILE = "Guia_Calouro.pdf";
    PDFView pdfView;
