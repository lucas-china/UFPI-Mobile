...
import ufpi.br.ufpimobile.CardapioActivity;
import ufpi.br.ufpimobile.R;
import ufpi.br.ufpimobile.Radio;
import ufpi.br.ufpimobile.SobreNos;
...
public class TelaHome extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewHolder.imageButton_mapa.setEnabled(false);
        mViewHolder.imageButton_mapa.setClickable(false);
        mViewHolder.imageButton_mapa.setAlpha(0.5f);
    ...
    public void onClick(View view) {
        ...
        switch (id) {
            ...
            case R.id.im_mapa:
                ...
                Intent in = new Intent(getApplication(), Mapas.class);
                startActivity(in);

                System.out.println("Ainda ta faltando integrar");
                break;
            case R.id.im_restaurante:
                Intent intent1 = new Intent(getApplication(), CardapioActivity.class);
                startActivity(intent1);
                break;

            case R.id.im_sobre:
                Intent intent2 = new Intent(getApplication(), SobreNos.class);
                startActivity(intent2);
                break;
            case R.id.im_radio:
                Intent intent3 = new Intent(getApplication(), Radio.class);
