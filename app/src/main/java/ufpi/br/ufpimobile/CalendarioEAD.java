...
public class CalendarioEAD extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendario_ead);
        ...
        final ArrayAdapter adapter = new ArrayAdapter(CalendarioEAD.this, android.R.layout.simple_list_item_1, informacoes);
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_CalendarioEAD);
